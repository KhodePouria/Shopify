    ...
    <footer className="text-gray-300 bg-gray-900">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="max-w-xs mb-4">
              Your trusted destination for premium tech products at competitive
              prices.
            </p>
      ...
      <div className="pt-8 pb-6 border-t border-gray-800">
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap justify-center gap-4">
            <div className="p-2 text-gray-400 bg-gray-800 rounded">
      ...
      <div className="py-4 bg-gray-950">
        <div className="container flex flex-col items-center justify-between px-4 mx-auto md:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-4 text-sm text-gray-500 md:mt-0">
            <Link
              href="/privacy"
