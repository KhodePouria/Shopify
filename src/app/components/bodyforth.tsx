...
export default function FeatureSection() {
  ...
  return (
    <section data-testid="cypress-fourth" className="py-20 bg-gray-50">
      ...
      <div className="container px-4 mx-auto">
        <div className="overflow-hidden shadow-xl bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="flex flex-col justify-center p-8 md:p-12">
              ...
              <p className="mb-6 text-blue-100">
                ...
                products, exclusive offers, and tech tips.
              </p>
              ...
              <form className="flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 font-semibold text-blue-600 transition-colors duration-300 bg-white rounded-lg hover:bg-blue-50"
                >
                  Subscribe
                </button>
              </form>
            ...
            <div className="relative flex flex-col justify-center p-8 bg-indigo-800 md:p-12">
              <div className="absolute top-0 right-0 w-40 h-40 -mt-20 -mr-20 bg-indigo-600 rounded-full opacity-20"></div>
              <div className="absolute bottom-0 left-0 w-24 h-24 -mb-12 -ml-12 bg-blue-400 rounded-full opacity-20"></div>

              <h2 className="relative z-10 mb-4 text-3xl font-bold text-white">
                Get Our Mobile App
              </h2>
              <p className="relative z-10 mb-6 text-blue-100">
                Shop on the go, track your orders, and get exclusive mobile-only
                deals.
              </p>
              ...
              <div className="relative z-10 flex flex-wrap gap-4">
                <a
                  href="#"
                  className="flex items-center px-4 py-2 text-white transition-colors duration-300 bg-black rounded-lg hover:bg-gray-900"
                >
                  <svg
