        ...
        <div className="overflow-hidden shadow-xl bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative flex flex-col justify-center p-8 bg-indigo-800 md:p-12">
              ...
              <h2 className="relative z-10 mb-4 text-3xl font-bold text-white">Get Our Mobile App</h2>
              ...
              <div className="relative z-10 flex flex-wrap gap-4">
                <a href="#" className="flex items-center px-4 py-2 text-white transition-colors duration-300 bg-black rounded-lg hover:bg-gray-900">
