      ...
      <div className="container px-4 py-16 mx-auto md:px-6">
        <div className="mb-12 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600">
            Discover our collection of high-quality techs designed for
            professionals.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div
                  ...
                  className="relative overflow-hidden bg-gray-100 h-72"
                >
                  <Image
                    src={imageUrl}
                    fill
                  ...
                  <div className="mt-auto">
                    <Link href={`/products/${product.slug}`}>
                      <button className="relative flex items-center justify-center w-full px-4 py-3 overflow-hidden font-medium text-white transition-colors duration-300 bg-blue-600 rounded-lg hover:cursor-pointer hover:bg-blue-700 group">
                        ...
                        <span className="absolute inset-0 flex items-center justify-center transition-transform duration-300 origin-left transform scale-x-0 bg-blue-800 group-hover:scale-x-100"></span>
                      </button>
                    </Link>
                  </div>
                </div>
